...
# ========== USER INPUT ==========
st.markdown("<h3><b>Enter the house details below and click Predict.</b></h3>",
            unsafe_allow_html=True)
...
chat_col1, chat_col2 = st.columns([9,1])
with chat_col2:
...
if st.session_state.chat_open:
    ...
    if user_input:
        ...
        if "median" in user_input.lower():
            reply = "Median house value is the middle price of homes in an area."
        elif "best place" in user_input.lower():
            reply = "Top California locations: San Diego, San Jose, Irvine, and Mountain View."
        else:
            reply = "Hi! I'm HouseBot 🤖 Ask me anything about houses."
